...
absolutepath_of_directory_with_xmlfiles = 'C:/Users/casas/Documents/dataset/yolo-test/leather/train/good/leather-PascalVOC-export/Annotations/'  #　It is okay to have a mix of xml files and images in the same directory.
absolutepath_of_directory_with_imgfiles = 'C:/Users/casas/Documents/dataset/yolo-test/leather/train/good/leather-PascalVOC-export/JPEGImages/'
absolutepath_of_directory_with_yolofiles = 'G:/マイドライブ/python_projects/yolov5-pipeline/dataset/'  # Yolo files will be created under this directory.
absolutepath_of_directory_with_classes_txt = 'G:/マイドライブ/python_projects/yolov5-pipeline/dataset/'  # You do not need to create classes.txt. classes.txt will be generated automatically.
absolutepath_of_directory_with_error_txt = 'G:/マイドライブ/python_projects/yolov5-pipeline/dataset/'  # The names of files that do not have a paired xml or image file will be written to a text file under this directory.
